...
As a software lead, your job is to come up with a low-level design in order to implement this feature. You are free to use any means of communication - document, diagrams, illustrations, or just verbal explanation. Your solution will be judged based on the following criteria:
